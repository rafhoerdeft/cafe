...
<head>
    ...
    {{-- <script src="{{ url('assets/js-plugin/pace.min.js') }}"></script> --}}
    <!-- Bootstrap CSS -->
...
<body>
        ...
        {{-- <nav class="navbar navbar-expand-lg navbar-light bg-white rounded fixed-top rounded-0 shadow-sm">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    <img src="{{ url('assets/images/logo-img.png') }}" width="140" alt="" />
                </a>
            ...
            <div class="container">
                <div class="card py-5">
                    <div class="row g-0">
                        ...
                        <div class="col-xl-7">
                            <img src="{{ url('assets/img/errors') }}/@yield('img')" class="img-fluid"
                                alt="">
                        </div>
                    </div>
                    <!--end row-->
    ...
    <!-- end wrapper -->
    <!-- Bootstrap JS -->
    <script src="{{ url('assets/js-plugin/bootstrap.bundle.min.js') }}"></script>
</body>
